...
Os preços vêm de config (PLANO_ATE_3_CENTS / PLANO_ATE_10_CENTS /
PLANO_MAIS_10_CENTS em config/settings.py), não são fixos aqui, pra dar
pra ajustar via .env sem alterar código.
"""
...
def valor_cents_do_plano(plano: str) -> int:
    ...
    info = PLANOS.get(plano) or PLANOS["ate_3"]
